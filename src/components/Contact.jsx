...
const Contact = () => {
  ...
  return (
    ...
    overflow-hidden">
      ...
      className="flex-[0.75] mulberry-gradient p-8 rounded-2xl">
        ...
        >
          ...
          className="bg-tertiary py-4 px-6 placeholer:text-secondary text-white 
      ...
      className="cl:flex-1 xl:w-[350px] md:h-[550px] h-[350px]">
        <EarthCanvas />
